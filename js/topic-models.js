...
window.TOPIC_MODELS = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "PAGASA classifies tropical cyclones by their maximum sustained winds near the center: <strong>Tropical Depression</strong> (30–88 km/h), <strong>Tropical Storm</strong> (89–117 km/h), <strong>Severe Tropical Storm</strong> (118–148 km/h), <strong>Typhoon</strong> (149–184 km/h) and <strong>Super Typhoon</strong> (185 km/h or more). The classification drives the public storm signals that follow.",
        ],
      },
    ],
  },
