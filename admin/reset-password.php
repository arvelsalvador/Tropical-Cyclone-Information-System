...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ((int) $_SESSION['reset_attempts'] >= 5) {
        unset($_SESSION['reset_email'], $_SESSION['reset_attempts']);
        header('Location: forgot-password.php');
        exit;
    }
  ...
  <main class="admin-main admin-main--auth">
    ...
    <section class="admin-card" data-reveal style="--reveal-delay: 0.08s">
      ...
      <form method="POST">
        ...
        <input type="password" id="new_password" name="new_password" placeholder="At least 10 characters" required minlength="10">
